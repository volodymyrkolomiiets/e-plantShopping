...
function ProductList() {
    ...
    const typePlants = useSelector((state)=> state.cart.items)
    ...
    const handleChangeItems = () => {
        setTotalItems(typePlants.length)
    }

useEffect(handleChangeItems, [typePlants.length])
